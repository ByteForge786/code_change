...
This is the initial python code to be updated:
```python
# TODO import all the dependencies required and avoid importing anything from collections
import pandas as pd
import numpy as np
...
def plot_chart(df: pd.DataFrame):
    ...
    4. Plot: Creating a chart and saving it to an image in './charts/temp_chart.png' (do not show the chart)
    \"\"\"
```"""
    return system_prompt, prompt
